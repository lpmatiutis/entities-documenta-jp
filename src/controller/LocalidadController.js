...
var localidad_1 = require("../entity/localidad");
var LocalidadController = /** @class */ (function () {
    function LocalidadController() {
        ...
        //     .getMany();
        // }
        this.userRepository = typeorm_1.getRepository(localidad_1.localidad);
    }
    LocalidadController.prototype.all = function (request, response, next) {
